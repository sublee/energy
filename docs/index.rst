...
will make players to come back to the game periodically.
...
You may want to save :class:`Energy` object within a specific player's data in
database.

An :class:`Energy` object is serializable by Pickle. If you have a key-value
storage, you can save an :class:`Energy` object with a player easily. Or, you
should prepare some columns for :attr:`Energy.used` and :attr:`Energy.used_at`
in your database to save them. Here’s an example of save/load an
:class:`Energy` object:
